...
export default function DataTable({handleOpen,setFormData,data}) {
  ...
  // Function to add unique IDs to rows
//   const addUniqueIds = (rows) => {
//     return rows.map((row, index) => {
//       // You can generate unique IDs in various ways
//       const id = `row_${index}`; // Using row index as ID
//       return { id, ...row };
//     });
//   };

// // Call the function to add unique IDs
//   const rowsWithIds = addUniqueIds(rows);
